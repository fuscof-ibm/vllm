...
def postprocess_mamba_fused_kernel(
    ...
    # block table. This avoids a per-step torch.stack copy of all groups.
    ...
    # Load the base address of this group's block table (int64) and reinterpret
    # as an int32 pointer, then advance element-wise by the per-request stride.
...
class MambaGPUContext:
    ...
    def run_fused_postprocess(
        ...
        Requires `initialize_block_table_ptrs` to have been called first.
